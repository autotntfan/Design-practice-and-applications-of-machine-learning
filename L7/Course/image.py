...
parser.add_argument('--image'    , help='Name of the single image to perform detection on. To run detection on multiple images, use --imagedir',default='2.jpg') 
...
for image_path in images:
    ...
    for i, position in enumerate(key_point_positions):
            ...
            if(confidenceScores[i]>0.1): 
                ...
                print("i=",i,"\t",x,y,"\t",confidenceScores[i])
    print(z)
    print(zz)
    if(zz-z<50):
        print('FALLLLL!!!')
